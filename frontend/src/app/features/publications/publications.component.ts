    ...
    <div>
      ...
      <section style="background-color: var(--primary-light); padding: 4rem 0;">
        <div class="container" style="text-align: center; max-width: 800px;">
          <span class="section-subtitle">{{ lang.isRtl() ? 'الأبحاث والمنشورات' : 'Peer-Reviewed Literature' }}</span>
            ...
            >
              <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.5rem;">
                <div style="display: flex; gap: 0.5rem;">
                  ...
                  <span class="badge badge-navy">{{ pub.year }}</span>
                </div>
              ...
              <div style="display: flex; gap: 0.75rem; margin-top: 0.5rem;">
                <button (click)="selectedPub = pub" class="btn btn-navy btn-sm">
                ...
                <a *ngIf="pub.pdfUrl" [href]="pub.pdfUrl" target="_blank" rel="noopener noreferrer" class="btn btn-outline btn-sm">
      ...
      <div *ngIf="selectedPub" class="modal-overlay" (click)="selectedPub = null">
        <div class="modal-content" (click)="$event.stopPropagation()" style="max-width: 750px;">
          ...
          <div style="display: flex; gap: 0.5rem; margin-bottom: 1rem;">
            <span class="badge badge-teal">{{ selectedPub.type }}</span>
            <span class="badge badge-navy">{{ selectedPub.year }}</span>
          </div>

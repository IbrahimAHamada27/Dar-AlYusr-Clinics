          ...
          <div style="display: flex; gap: 3rem; flex-wrap: wrap; align-items: center;">
            ...
            <div style="flex: 1 1 450px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; font-weight: 700; color: #0f172a;">
                <div>✓ طوارئ واستقبال على مدار 24 ساعة بأخصائيين مقيمين.</div>
                <div>✓ مركز اليسر المتخصص لطب الأسنان والتخدير الكلي للأطفال والكبار.</div>
                <div>✓ أحدث وحدات رسم المخ ورسم العصب والسونار التخصصي.</div>
                <div>✓ أكثر من 20 عيادة تخصصية تحت إشراف نخبة من كبار الأطباء والاستشاريين.</div>
              </div>
            </div>

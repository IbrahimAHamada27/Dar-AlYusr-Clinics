    ...
    <div>
      ...
      <section style="background-color: var(--primary-light); padding: 4rem 0;">
        <div class="container" style="text-align: center; max-width: 800px;">
          <span class="section-subtitle">{{ lang.isRtl() ? 'الاعتمادات التخصصية' : 'Verified Credentials' }}</span>
      ...
      <section class="section">
        <div class="container">
          <div class="grid-3">
            <div *ngFor="let cert of data.certificates()" class="card card-hover" style="display: flex; flex-direction: column; justify-content: space-between;">
              <div>
              ...
              <div style="display: flex; gap: 0.5rem;">
                <button (click)="selectedCert = cert" class="btn btn-outline btn-sm" style="flex: 1;">
                ...
                <a *ngIf="cert.verificationUrl" [href]="cert.verificationUrl" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-sm" title="Verify Online" style="padding: 0.45rem 0.65rem;">
      ...
      <div *ngIf="selectedCert" class="modal-overlay" (click)="selectedCert = null">
        <div class="modal-content" (click)="$event.stopPropagation()">
          ...
          <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem;">
            ...
            <span class="badge badge-teal">{{ selectedCert.year }}</span>
          </div>
          ...
          <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
            <a *ngIf="selectedCert.verificationUrl" [href]="selectedCert.verificationUrl" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-sm">
            ...
            <button (click)="selectedCert = null" class="btn btn-outline btn-sm">

          ...
          <div style="position: relative; z-index: 2; display: flex; align-items: center; justify-content: space-between; gap: 2rem; flex-wrap: wrap;">
            ...
            <div style="flex: 0 0 200px; text-align: center;">
              <img
                ...
                style="height: 100px; border-radius: 20px; background: #ffffff; padding: 6px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); border: 3px solid #f59e0b;"
              />
            </div>
          </div>
        </div>
        ...
        <div class="grid-2" style="gap: 2rem; margin-bottom: 3rem;">
          ...
          <div style="background: #ffffff; border: 2px solid #e2e8f0; border-radius: 20px; padding: 2rem; box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
            ...
            <ul style="list-style: none; padding: 0; display: flex; flex-direction: column; gap: 0.6rem; font-size: 0.9rem; color: #334155; font-weight: 700; margin-bottom: 1.5rem;">
              <li>• مناسب لحالات الخوف الشديد وعدم التعاون للأطفال والكبار</li>
              <li>• إمكانية إجراء أكثر من علاج في جلسة واحدة بدون ألم</li>
              <li>• راحة أكبر للمريض وتقييم كامل من أطباء التخدير والأسنان</li>
            </ul>
          ...
          <div style="background: #ffffff; border: 2px solid #e2e8f0; border-radius: 20px; padding: 2rem; box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
            ...
            <p style="font-size: 0.95rem; color: #475569; line-height: 1.65; margin-bottom: 1.25rem;">
              الابتسامة الحلوة بتبدأ من أسنان صحية، قبل الزحمة والدراسة والواجبات، خدي خطوة بسيطة واعملي لطفلك كشف أسنان شامل عشان نكتشف أي تسوس أو مشكلة بدري ونبدأ السنة بابتسامة صحية وواثقة.
            </p>
              ...
              <table style="width: 100%; border-collapse: collapse; text-align: start; font-size: 0.95rem;">
                <thead>
                  <tr style="background: #0f172a; color: #ffffff; font-weight: 900;">
                    ...
                    <th style="padding: 1rem 1.25rem; text-align: start;">الفترة الصباحية</th>

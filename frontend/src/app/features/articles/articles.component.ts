    ...
    <div>
      ...
      <section style="background-color: var(--primary-light); padding: 4rem 0;">
        <div className="container" style="text-align: center; max-width: 800px;">
          <span className="section-subtitle">{{ lang.isRtl() ? 'التوعية والإرشاد' : 'Patient Health Education' }}</span>
      ...
      <!-- Category Pills Bar -->
      <section className="section" style="padding-top: 2rem; padding-bottom: 1rem;">
      ...
      <!-- Articles Cards Grid -->
      <section className="section" style="padding-top: 1.5rem;">
        <div className="container">
            ...
            >
              ...
              <div style="height: 200px; width: 100%; overflow: hidden; position: relative;">
                ...
                <div style="position: absolute; top: 1rem;" [style.right]="lang.isRtl() ? '1rem' : 'auto'" [style.left]="lang.isRtl() ? 'auto' : '1rem'">
                  <span className="badge badge-teal" style="background-color: rgba(255,255,255,0.92);">
              ...
              <div style="padding: 1.5rem; flex: 1; display: flex; flex-direction: column; justify-content: space-between;">
                ...
                <button (click)="activeArticle = art" className="btn btn-navy btn-sm" style="width: 100%; justify-content: center;">
      ...
      <div *ngIf="activeArticle" className="modal-overlay" (click)="activeArticle = null">
        <div className="modal-content" (click)="$event.stopPropagation()" style="max-width: 850px; max-height: 92vh; overflow-y: auto;">
          ...
          <div style="display: flex; gap: 0.5rem; margin-bottom: 0.75rem;">
            <span className="badge badge-teal">{{ lang.getText(activeArticle.category) }}</span>
          ...
          <button (click)="activeArticle = null" className="btn btn-outline btn-sm" style="width: 100%; justify-content: center;">
